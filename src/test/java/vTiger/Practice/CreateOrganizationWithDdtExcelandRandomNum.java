...
public class CreateOrganizationWithDdtExcelandRandomNum {
				...
				//step 4: navigate to required row inside the sheet
				 ...
				 //step 5: navigate to required cell inside the row
				  ...
				  WebDriver driver = null;
			       ...
			       // driver.findElement(By.name("accountname")).sendKeys(ORGNAME+value);//one method of printing ORGNAME with random number
			        
			        
			        driver.findElement(By.name("accountname")).sendKeys(ORG);//another method of printing ORGNAME with random number
